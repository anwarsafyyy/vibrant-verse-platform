    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#f8f6f3]">
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center min-h-screen py-32">
          ...
          {/* Floating Icons with Connections - Static Layout */}
          <div className="relative w-full max-w-5xl h-[400px] md:h-[480px] mb-12">
            
            {/* SVG Connection Lines */}
            <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1000 480" fill="none" preserveAspectRatio="xMidYMid meet">
              {/* Left side connections */}
              <path d="M160 70 L440 200" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              <path d="M100 200 L420 220" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              <path d="M180 350 L440 260" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              {/* Right side connections */}
              <path d="M560 200 L840 70" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              <path d="M580 220 L900 200" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              <path d="M560 260 L820 350" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              {/* Bottom connections */}
              <path d="M360 420 L460 280" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              <path d="M500 300 L500 400" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
              <path d="M640 420 L540 280" stroke="#d1d5db" strokeWidth="1.5" strokeDasharray="6 6" />
            </svg>

            {/* Flutter/Dart - Top Left */}
            <div className="absolute left-[5%] md:left-[10%] top-[5%] w-14 h-14 md:w-16 md:h-16 bg-[#02569B] rounded-2xl flex items-center justify-center shadow-lg">
            ...
            {/* OpenAI - Left Middle */}
            <div className="absolute left-[2%] md:left-[5%] top-[35%] w-14 h-14 md:w-16 md:h-16 bg-[#000000] rounded-2xl flex items-center justify-center shadow-lg">
            ...
            {/* ML/AI - Left Bottom */}
            <div className="absolute left-[10%] md:left-[15%] top-[65%] w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#FF6F61] to-[#DE4DAB] rounded-2xl flex items-center justify-center shadow-lg">
              <Brain className="w-8 h-8 md:w-9 md:h-9 text-white" />
            </div>

            {/* Center Logo (Main) */}
            <div className="absolute left-1/2 top-[30%] -translate-x-1/2 -translate-y-1/2 w-36 h-36 md:w-48 md:h-48 bg-white rounded-3xl flex items-center justify-center shadow-2xl border border-gray-100">
              <img 
            ...
            {/* Node.js - Top Right */}
            <div className="absolute right-[5%] md:right-[10%] top-[5%] w-14 h-14 md:w-16 md:h-16 bg-[#339933] rounded-2xl flex items-center justify-center shadow-lg">
              <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-9 md:h-9 text-white" fill="currentColor">
            ...
            <div className="absolute right-[2%] md:right-[5%] top-[35%] w-14 h-14 md:w-16 md:h-16 bg-[#3178C6] rounded-2xl flex items-center justify-center shadow-lg">
              <span className="text-white font-black text-xl md:text-2xl">TS</span>
            </div>

            {/* React - Right Bottom */}
            <div className="absolute right-[10%] md:right-[15%] top-[65%] w-14 h-14 md:w-16 md:h-16 bg-[#61DAFB] rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div className="absolute left-[25%] md:left-[30%] top-[82%] w-14 h-14 md:w-16 md:h-16 bg-[#FFCA28] rounded-2xl flex items-center justify-center shadow-lg">
              <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-9 md:h-9" fill="none">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-[82%] w-14 h-14 md:w-16 md:h-16 bg-[#6366F1] rounded-2xl flex items-center justify-center shadow-lg">
              <Server className="w-8 h-8 md:w-9 md:h-9 text-white" />
            </div>

            {/* Google Cloud - Bottom Right */}
            <div className="absolute right-[25%] md:right-[30%] top-[82%] w-14 h-14 md:w-16 md:h-16 bg-white rounded-2xl flex items-center justify-center shadow-lg border border-gray-100">
