  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32">
      ...
      <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center max-w-5xl">
        ...
        >
          ...
          <div className="mb-12 flex justify-center">
            <img 
              ...
              alt="Company Logo" 
              className="h-[512px] w-auto md:h-[768px] lg:h-[1024px] object-contain drop-shadow-2xl animate-scale-in"
            />
          </div>
        ...
        {/* Feature Preview Cards - Glass Morphism */}
        <div 
        ...
        >
          <div className="relative group">
            ...
            <div className="relative glass-effect border border-white/10 rounded-3xl p-8 text-center hover:-translate-y-2 transition-all duration-500 backdrop-blur-xl">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/50 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2 font-['Lama_Sans']">{language === 'ar' ? 'تصميم حديث' : 'Modern Design'}</h3>
              <p className="text-sm text-muted-foreground font-['Lama_Sans']">{language === 'ar' ? 'واجهات عصرية وسلسة' : 'Clean & smooth interfaces'}</p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative glass-effect border border-white/10 rounded-3xl p-8 text-center hover:-translate-y-2 transition-all duration-500 backdrop-blur-xl">
              <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-emerald-500/50 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2 font-['Lama_Sans']">{language === 'ar' ? 'تقنيات متطورة' : 'Advanced Tech'}</h3>
              <p className="text-sm text-muted-foreground font-['Lama_Sans']">{language === 'ar' ? 'حلول تقنية مبتكرة' : 'Innovative solutions'}</p>
            </div>
          </div>
          
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-pink-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
            <div className="relative glass-effect border border-white/10 rounded-3xl p-8 text-center hover:-translate-y-2 transition-all duration-500 backdrop-blur-xl">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-500/50 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2 font-['Lama_Sans']">{language === 'ar' ? 'دعم مستمر' : '24/7 Support'}</h3>
              <p className="text-sm text-muted-foreground font-['Lama_Sans']">{language === 'ar' ? 'دعم فني متواصل' : 'Always here to help'}</p>
            </div>
          </div>
        </div>
      </div>
