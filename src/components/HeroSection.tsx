      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center min-h-screen py-32">
          ...
          <div className={`relative w-full max-w-5xl h-[400px] md:h-[450px] mb-12 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            ...
            {/* Node.js - Top Left */}
            <div className="absolute left-[5%] md:left-[10%] top-[10%] w-14 h-14 md:w-16 md:h-16 bg-[#339933] rounded-2xl flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="absolute left-[2%] md:left-[8%] top-[40%] w-14 h-14 md:w-16 md:h-16 bg-[#3178C6] rounded-2xl flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '0.6s' }}>
              <span className="text-white font-black text-xl md:text-2xl">TS</span>
            </div>

            {/* React - Left Bottom */}
            <div className="absolute left-[8%] md:left-[15%] top-[70%] w-14 h-14 md:w-16 md:h-16 bg-[#61DAFB] rounded-2xl flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '0.9s' }}>
            ...
            {/* Flutter/Dart - Top Right */}
            <div className="absolute right-[5%] md:right-[10%] top-[10%] w-14 h-14 md:w-16 md:h-16 bg-[#02569B] rounded-2xl flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '0.4s' }}>
            ...
            {/* OpenAI - Right Middle */}
            <div className="absolute right-[2%] md:right-[8%] top-[40%] w-14 h-14 md:w-16 md:h-16 bg-[#000000] rounded-2xl flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '0.7s' }}>
              <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-9 md:h-9 text-white" fill="currentColor">
            ...
            {/* ML/AI - Right Bottom */}
            <div className="absolute right-[8%] md:right-[15%] top-[70%] w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#FF6F61] to-[#DE4DAB] rounded-2xl flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '1s' }}>
