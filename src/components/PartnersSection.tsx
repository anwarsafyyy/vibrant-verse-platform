...
const PartnersSection: React.FC = () => {
  ...
  return (
    <section id="partners" className="py-16 lg:py-24 relative overflow-hidden bg-white">
      ...
      />
      <div 
        className="absolute bottom-24 right-20 w-7 h-7 border-2 border-purple-400/15 rotate-45 hidden lg:block transition-all duration-300 animate-[float_4s_ease-in-out_infinite_0.7s]"
      />
